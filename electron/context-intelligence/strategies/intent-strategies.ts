...
export const TRACE_BUG: AnswerStrategy = {
  ...
  promptSection:
    ...
    'narrow the hypotheses, say what you would look at first.',
  steps: [
...
export const DESIGN_CLASSES: AnswerStrategy = {
  ...
  promptSection:
    ...
    'Present key interfaces and methods, not full implementations. Walk through a primary use ' +
    'case end-to-end using the class model to show the design works. Identify one or two ' +
    'extension points — where the design allows new features without modification. Apply SOLID ' +
    'principles where they simplify the design, but do not apply them mechanically. Mention a ' +
    'design pattern only if it fits naturally; do not force one.',
  steps: [
    ...
    'Define key interfaces and methods (signatures, not implementations).',
...
export const DESCRIBE_PROJECT: AnswerStrategy = {
  ...
  promptSection:
    ...
    'it reads as credibility, not weakness.',
  steps: [
...
export const NARRATE_EXPERIENCE: AnswerStrategy = {
  ...
  promptSection:
    ...
    'result that shows measurable impact or learning. One sentence of genuine reflection ' +
    '("I would do X differently now") adds credibility.',
  steps: [
...
export const TELL_BEHAVIORAL_STORY: AnswerStrategy = {
  ...
  promptSection:
    ...
    'judgment and self-awareness, not just what happened.',
  steps: [
    ...
    'Reflection: acknowledge what you learned or would do differently.',
  ],
};
...
export const INTRODUCE_SELF: AnswerStrategy = {
  ...
  steps: [
    ...
    '(If contextually appropriate) Connect to why this role or company interests you.',
  ],
};
...
export const CONTINUE_THREAD: AnswerStrategy = {
  ...
  promptSection:
    ...
    'appropriately brief — a follow-up is a continuation, not a new explanation. Phase 4 ' +
    'topic-chain context is available to inform what the follow-up refers to.',
  steps: [
